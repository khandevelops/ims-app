...
export const createDepartmentItem = (params: { state: string, id: number, departmentItem: IDepartment }) => {
    return axios.post(`${baseUrl}${params.state}/${params.id}`, params.departmentItem)
}
