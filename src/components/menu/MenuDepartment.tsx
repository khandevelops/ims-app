    ...
    <AppBar position="static" elevation={5} sx={{ backgroundColor: "#1347a4" }}>
      <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          {profileDetailSelector.profileDetail?.department ===
            DEPARTMENT.SPECIMEN_PROCESSING && (
            <Button
              sx={{
                color:
          ...
          {profileDetailSelector.profileDetail?.department ===
            ...
            <Button
              sx={{
                color:
                  location.pathname === "/departments/rd" ? "yellow" : "#fff",
                fontWeight: "700",
              }}
              component={Link}
              to="/departments/rd"
          ...
          {profileDetailSelector.profileDetail?.department ===
            ...
            <Button
              sx={{
                color:
                  location.pathname === "/departments/qc-internal-standards"
                    ? "yellow"
                    : "#fff",
                fontWeight: "700",
              }}
          ...
          <Button
            sx={{
              color:
                location.pathname === "/departments/general-request/list"
                  ? "yellow"
                  : "#fff",
              fontWeight: "700",
            }}
          ...
          <Button
            sx={{
              color:
                location.pathname === "/departments/office-supply-request/list"
                  ? "yellow"
                  : "#fff",
              fontWeight: "700",
            }}
          ...
          <Button
            sx={{
              color:
                location.pathname === "/departments/store-room-request/list"
                  ? "yellow"
                  : "#fff",
              fontWeight: "700",
            }}
