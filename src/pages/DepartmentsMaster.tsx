...
const DepartmentsMaster = () => {
  const masterDepartmentItemsSelector = useAppSelector(
    selectMasterDepartmentItems
  );
        ...
        .then(() => {
          if (inputRef) {
            ...
            setTimeout(() => {
              ...
              inputRef.style.transition =
                "1s background ease-in, 300ms transform ease-out 1s";
            }, 600);
          }
        })
        .catch((error: Error) => {
                ...
                ? masterDepartmentItem.departmentItems.map(
                  (departmentItem) => ({
                    ...
                    expiration_date:
                      departmentItem.id === departmentItemId
                        ? value
                        : departmentItem.expiration_date,
                  })
                )
                : masterDepartmentItem.departmentItems,
          })
  ...
  const getTotalQuantity = (departmentItems: IDepartment[]) => {
    return departmentItems.reduce(
      (acc, departmentItem) => acc + departmentItem.quantity,
      0
    );
  };
                ...
                (masterDepartmentItem, index) => (
                  <Fragment key={index}>
                    <StyledTableRow hover>
                      ...
                      <StyledTableCell>
                        {masterDepartmentItem.part_number}
                      </StyledTableCell>
                      <StyledTableCell>
                        {masterDepartmentItem.recent_cn}
                      </StyledTableCell>
                      <StyledTableCell sx={{ width: 200 }}>
                        {masterDepartmentItem.recent_vendor}
                      </StyledTableCell>
                      <StyledTableCell>
                        {masterDepartmentItem.drug_class}
                      </StyledTableCell>
                      ...
                      <StyledTableCell
                        sx={{
                          backgroundColor: getOrderQuantity(
                            masterDepartmentItem.departmentItems[0]
                              .minimum_quantity,
                            masterDepartmentItem.departmentItems[0]
                              .maximum_quantity,
                            getTotalQuantity(
                                    ...
                                    >
                                      <TextField
                                        ...
                                        onKeyDown={(
                                          ...
                                          handleEnterKey(event, departmentItem, inputRef.current.minimum_quantity)
                                        }
                                      />
                                    </StyledSubTableCell>
                                    <StyledSubTableCell
                                    ...
                                    >
                                      <TextField
                                        ...
                                        onKeyDown={(
                                          ...
                                          handleEnterKey(event, departmentItem, inputRef.current.maximum_quantity)
                                        }
                                      />
                                    </StyledSubTableCell>
                                    <StyledSubTableCell align="left">
                                      <TextField
                                        ...
                                        onKeyDown={(
                                          ...
                                          handleEnterKey(event, departmentItem, inputRef.current.usage_level)
                                        }
                                      />
                                    </StyledSubTableCell>
                                    <StyledSubTableCell align="left">
                                    ...
                                    <StyledSubTableCell align="left">
                                      <TextField
                                        ...
                                        onKeyDown={(
                                          ...
                                          handleEnterKey(event, departmentItem, inputRef.current.lot_number)
                                        }
                                      />
                                    </StyledSubTableCell>
                                    <StyledSubTableCell align="left">
