...
const RequestMasterDepartmentItems = () => {
  ...
  const handleCheckboxChange = (
    ...
    const exists =
      requestMasterItemsCheckedSelector.requestMasterItemsChecked.some(
  ...
  return (
    <Box component={Paper} elevation={3}>
        ...
        <Table size="small" stickyHeader>
          ...
          <TableBody>
            {requestMasterItemsSelector.response.content.length > 0 &&
              requestMasterItemsSelector.response.content.map(
                (requestMasterItem, index) => (
                  <TableRow key={index}>
                    ...
                    <StyledTableCell>
                      {requestMasterItem.purchase_unit}
                    </StyledTableCell>
                    <StyledTableCell>
                      {requestMasterItem.part_number}
                    </StyledTableCell>
                    <StyledTableCell>
      ...
      <Drawer
        anchor="bottom"
        open={type === DRAWER_TOGGLE_TYPE.UPDATE_REQUEST_REVIEW}
      >
