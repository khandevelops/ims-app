      ...
      <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          <Button
            ...
            sx={{
              color:
                location.pathname === "/admin/store-room" ? "yellow" : "#fff",
              fontWeight: "700",
            }}
            component={Link}
            to="/admin/store-room"
          ...
          <Button
            ...
            sx={{
              color:
                location.pathname === "/admin/request/general"
                  ? "yellow"
                  : "#fff",
              fontWeight: "700",
            }}
          ...
          <Button
            ...
            sx={{
              color:
                location.pathname === "/admin/request/office-supply"
                  ? "yellow"
                  : "#fff",
              fontWeight: "700",
            }}
          ...
          <Button
            ...
            sx={{
              color:
                location.pathname === "/admin/request/store-room"
                  ? "yellow"
                  : "#fff",
              fontWeight: "700",
            }}
