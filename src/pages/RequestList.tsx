...
import { getRequestListItemsThunk } from '../app/requestList/requestListItemSlice';
...
const RequestList = () => {
    ...
    const handleStatusChange = (event: SelectChangeEvent, requestItem: IRequestMakeItem) => {
        dispatch(
            changeRequestItems(
