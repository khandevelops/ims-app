...
export const { changeMasterDepartmentItems } =
  masterDepartmentItemsSlice.actions;
export const selectMasterDepartmentItems = (state: RootState) =>
  state.masterDepartmentItemsStore;
