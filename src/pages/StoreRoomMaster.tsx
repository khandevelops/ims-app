...
const StoreRoomMaster = () => {
  const storeRoomMasterItemsSelector = useAppSelector(
    selectStoreRoomMasterItems
  );
        ...
        <Table stickyHeader size="small">
          ...
          <TableBody>
            {storeRoomMasterItemsSelector.response &&
              ...
              storeRoomMasterItemsSelector.response.content.map(
                (storeRoomMasterItem, index) => (
                  <TableRow key={index} hover>
                    <StyledTableCell>
                      {storeRoomMasterItem.masterItem.item}
                    </StyledTableCell>
                    <StyledTableCell>
                      {storeRoomMasterItem.masterItem.purchase_unit}
                    </StyledTableCell>
                    <StyledTableCell>
                      {storeRoomMasterItem.masterItem.part_number}
                    </StyledTableCell>
                    <StyledTableCell>
                      {storeRoomMasterItem.masterItem.recent_cn}
                    </StyledTableCell>
                    <StyledTableCell>
                    ...
                    <StyledTableCell>
                      <TextField
                        ...
                        onKeyDown={(event: KeyboardEvent) =>
                          handleStoreRoomItemUpdate(
                            storeRoomMasterItem.id,
                            event
                          )
                        }
