...
const Dashboard = () => {
  ...
  const getProfileDetail = (id: string) => {
    return profileDetailsSelector.profileDetails.find(
  ...
  const handleDepartmentChange = (id: string, event: SelectChangeEvent) => {
    const profileDetail = profileDetailsSelector.profileDetails.find(
      (profileDetail) => profileDetail.id === id
    );
    if (profileDetail) {
      dispatch(
  ...
  const handleRoleChange = (id: string, event: SelectChangeEvent) => {
    const profileDetail = profileDetailsSelector.profileDetails.find(
      (profileDetail) => profileDetail.id
    );
    if (profileDetail) {
      dispatch(
        updateProfileDetailThunk({
        ...
        dispatch(
          changeProfileDetails(
            profileDetailsSelector.profileDetails.map((profileDetail) => ({
              ...
              role:
                profileDetail.id === id
                  ? profileDetailResponse.payload.role
                  : profileDetail.role,
            }))
          )
        );
