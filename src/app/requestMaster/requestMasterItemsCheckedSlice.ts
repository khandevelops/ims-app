...
export const selectRequestMasterItemsChecked = (state: RootState) =>
  state.requestMasterItemsCheckedStore;

export const { changeRequestItemsChecked } =
  requestMasterItemsCheckedSlice.actions;
